...
},{}],"app/getFollowers.js":[function(require,module,exports) {
"use strict";
...
var URL = "https://api.github.com/users/markodenic/followers?per_page=100";
...
;
var _default = getFollowers;
exports.default = _default;
},{"../node_modules/axios/index":"node_modules/axios/index.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js"}],"app/displayFollowers.js":[function(require,module,exports) {
"use strict";
...
function displayFollowers(_ref) {
  var followers = _ref.followers;
  var apiFollowers = followers.map(function (follower) {
    var id = follower.id,
        image = follower.avatar_url,
        username = follower.login,
        profile = follower.html_url,
        repos = follower.repos_url;
    return "\n            <article class=\"follower\">\n                <img src=\"".concat(image, "\" alt=\"follower />\"\n                <h4>").concat(username, "</h4>\n                <small>id: ").concat(id, "</small>\n                <div>\n                    <a href=\"").concat(profile, "\" target=\"_blank\" class=\"btn\">profile</a>\n                    <a href=\"").concat(repos, "\" target=\"_blank\" class=\"btn\">repos</a>\n                </div>\n            </article>\n        ");
  });
  var followsersList = document.querySelector(".followers-container");
  followsersList.innerHTML = apiFollowers.join("");
}

;
var _default = displayFollowers;
exports.default = _default;
},{}],"app/displayButtons.js":[function(require,module,exports) {
"use strict";
...
function displayButtons(_ref) {
  var pages = _ref.pages,
      mainIdx = _ref.mainIdx,
      btnContainer = _ref.btnContainer;
  var buttons = pages.map(function (_, pageIdx) {
    return "\n            <button\n                class=\"page-btn ".concat(pageIdx === mainIdx ? "active-btn" : "", "\"\n                data-index=").concat(pageIdx, ">\n                ").concat(pageIdx + 1, "\n            </button>\n        ");
  });
...
;
var _default = displayButtons;
exports.default = _default;
},{}],"app/pagination.js":[function(require,module,exports) {
"use strict";
...
function pagination(_ref) {
  var followers = _ref.followers;
  var followersPerPage = 10;
  var totalPages = Math.ceil(followers.length / followersPerPage);
  var paginatedFollowers = Array.from({
    length: totalPages
  }, function (_, index) {
    return followers.slice(index * followersPerPage, (index + 1) * followersPerPage); // const start = index * followersPerPage;
...
var _getFollowers = _interopRequireDefault(require("./getFollowers"));

var _displayFollowers = _interopRequireDefault(require("./displayFollowers"));

var _displayButtons = _interopRequireDefault(require("./displayButtons"));
...
function pageTracker() {
  var index = 0;
  /* `index` is keeping track of which page of followers is being displayed. */

  var pages = [];
  /* `pages` is an array of arrays. Each array is a page of followers. */
...
var _pageTracker = pageTracker(),
    pages = _pageTracker.pages,
    index = _pageTracker.index,
    btnContainer = _pageTracker.btnContainer;

function setupUI() {
  (0, _displayFollowers.default)({
    followers: pages[index]
  });
  (0, _displayButtons.default)({
    pages: pages,
    mainIdx: index,
    btnContainer: btnContainer
  });
...
function eventTriggering() {
  btnContainer.addEventListener("click", function (e) {
    var btn = e.target; // omiting the return statement

    btn.classList.contains("btn-contanier") ? index = 0 : null;
    if (btn.classList.contains("page-btn")) index = +btn.dataset.index;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _getFollowers.default)();

          case 3:
            followers = _context.sent;
            pages = (0, _pagination.default)({
              followers: followers
            });
            setupUI();
            eventTriggering();
...
},{"./getFollowers":"app/getFollowers.js","./displayFollowers":"app/displayFollowers.js","./displayButtons":"app/displayButtons.js","./pagination":"app/pagination.js"}],"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
